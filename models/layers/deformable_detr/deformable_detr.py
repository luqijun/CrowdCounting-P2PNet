...
class DeformableDETR(nn.Module):
    ...
    def __init__(self, in_channels_list, transformer, num_feature_levels):
...
def build_deformable_detr(in_channels = [256], num_feature_levels=4):

    transformer = build_deforamble_transformer(num_feature_levels)
